...
//redux
import { mapTransactionToNodeData, mapTransactionFields } from '@/components/graph/NodesAndEdges'
...
import DefaultNode from '@/components/graph/nodes/DefaultNode'
import RedNode from '@/components/graph/nodes/RedNode'
